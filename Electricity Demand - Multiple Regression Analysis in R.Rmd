...
#Firstly, it only has one year to observe. The model can benefit from better explanation if we can include more than one year and turn the model into a time series/panel data analysis. Lastly, there are also some statistically significant variables at the 10% level which is below the level of 1%.
