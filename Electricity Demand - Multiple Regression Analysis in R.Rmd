...
#This is a multivariate regression analysis examining whether there is a relationship between the electricity demand (response variable) and GDP per capita in USD, urban population percentage of total population & precipitation in a country (predictor variables).
